 ...
 * @author netto
 */
public class ControladoraDatosPersonales implements ActionListener, MouseListener, KeyListener {
    ...
    public ControladoraDatosPersonales(VentanaCliente vClient, VentanaDatosPersonalesCliente vDP, Modelo modelo) {
        ...
        try {
            ...
            Logger.getLogger(ControladoraDatosPersonales.class.getName()).log(Level.SEVERE, null, ex);
...
//            JOptionPane.showMessageDialog(null, "Los datos fueron actualizados correctamente!");
            ...
            this.modelo.modificarCliente(cl);
            this.opcionAtras();
