...
import Controladora.ControladoraDatosPersonalesAdmin;
 ...
 * @author netto
 */
public class VentanaDatosPersonalesAdmin extends javax.swing.JFrame implements Observer {
    ...
    public VentanaDatosPersonalesAdmin() {
        initComponents();
    ...
    public void setControl(ControladoraDatosPersonalesAdmin cDP) {
        this.cDP = cDP;
    ...
    public void update(Observable updatedModel, Object param) {
            Modelo m = (Modelo) updatedModel;
                ...
                Logger.getLogger(VentanaDatosPersonalesAdmin.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
    ...
    private void initComponents() {
        ...
        lAdministrador.setText(" Datos del administrador");
        ...
        lFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/q88.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaDatosPersonalesAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VentanaDatosPersonalesAdmin().setVisible(true);
        });
    }

    public ControladoraDatosPersonalesAdmin getcDP() {
        return cDP;
    }

    public void setcDP(ControladoraDatosPersonalesAdmin cDP) {
        this.cDP = cDP;
    }
