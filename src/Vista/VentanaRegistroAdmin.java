...
import Controladora.ControladoraRegistroAdmin;
...
public class VentanaRegistroAdmin extends javax.swing.JFrame {
   ...
   public void setControl(ControladoraRegistroAdmin cRegAdm){
       this.cRegAdm=cRegAdm;
       
       // Delegar control de Mouse a Controladora Registro
       bCompletar.addMouseListener(cRegAdm);
       bCancelar.addMouseListener(cRegAdm);
       bFecha.addMouseListener(cRegAdm);
       bAtras.addMouseListener(cRegAdm);
       bCerrar.addMouseListener(cRegAdm);
       bMinimizar.addMouseListener(cRegAdm);
       
       // Delegar control de Accion a Controladora Registro
       bCompletar.addActionListener(cRegAdm);
       bCancelar.addActionListener(cRegAdm);
       bAtras.addActionListener(cRegAdm);
       bCerrar.addActionListener(cRegAdm);
       bMinimizar.addActionListener(cRegAdm);
      
       
       // Delegar control de Teclado a Controladora Registro
       bCompletar.addKeyListener(cRegAdm);
       bCancelar.addKeyListener(cRegAdm);
       bAtras.addKeyListener(cRegAdm);
       bCerrar.addKeyListener(cRegAdm);
       bMinimizar.addKeyListener(cRegAdm);
       
       // Escuchar los eventos del teclado y mouse 
       this.addMouseListener(cRegAdm);
       this.addKeyListener(cRegAdm);
   }
    ...
    private void initComponents() {
        ...
        lRegistro.setText("Registro administrador");
        ...
        lFondo2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/q222.jpg"))); // NOI18N
    ...
    public ControladoraRegistroAdmin getcRegAdm() {
        return cRegAdm;
    }

    public void setcRegAdm(ControladoraRegistroAdmin cRegAdm) {
        this.cRegAdm = cRegAdm;
    }
